<script>
  const sections = [
    {
      title: "Overview",
      content: `This website is operated by HappyCrown Limited. Throughout the site, the terms "we", "us" and "our" refer to BloxyFruit. BloxyFruit offers this website, including all information, tools, and Services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies, and notices stated here.
...
In no case shall BloxyFruit, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.`
    },
    {
      title: "Indemnification",
      content: `You agree to indemnify, defend and hold harmless BloxyFruit and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys' fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.`
    },
    {
      title: "Severability",
...
Any ambiguities in the interpretation of these Terms of Service shall not be construed against the drafting party.`
    ...
    {
      title: "Governing Law",
      content: `These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of [Your Address].`
    },
    {
...
<svelte:head>
  <title>Terms of Service - BloxyFruit</title>
  <meta name="description" content="Read BloxyFruit's Terms of Service to understand the rules and guidelines for using our platform." />
</svelte:head>

<div class="flex flex-col items-center pt-[120px]">
  <!-- Background elements -->
  <div class="absolute top-[500px] left-[-250px] size-[250px] bg-[#3BA4F0]/50 blur-[250px]"></div>

  <div class="max-w-[1000px] w-full flex justify-center flex-col px-4 sm:px-6">
    <h1 class="font-extrabold text-4xl md:text-5xl text-center mb-8">Terms of Service</h1>

    <div class="prose prose-invert max-w-none">
      {#each sections as section}
        <section class="mb-12">
          <h2 class="text-2xl font-bold mb-4">{section.title}</h2>
          <div class="text-[#809BB5] space-y-4">
      ...
      <div class="mt-12 p-6 rounded-lg bg-[#1D2535]/45 backdrop-blur-sm">
        <h3 class="text-xl font-bold mb-3">Contact Information</h3>
        <p class="text-[#809BB5] font-medium">
          Questions about the Terms of Service should be sent to us at 
          <a href="mailto:sepiandnahid@gmail.com" class="text-[#3BA4F0] hover:underline">sepiandnahid@gmail.com</a>
        </p>
      </div>
    </div>
  </div>
