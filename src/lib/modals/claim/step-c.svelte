<script>
  ...
  function handleCreate() {
    ...
    window.open(
      `https://create.roblox.com/dashboard/creations/experiences/${data.game.id}/monetization/passes`,
      '_blank'
    );
  }
  ...
  function handleTutorial() {
    ...
    window.open('https://www.youtube.com/watch?v=KsSX7WYAMY0', '_blank');
  }
...
<div class="flex flex-col gap-6" in:fade={{ duration: 300, delay: 200 }}>
  ...
  <div class="flex flex-col items-center gap-6 pt-4">
    ...
    >
      <div
        class="absolute inset-0 transform scale-125 rounded-full bg-accent-500/20 blur-xl"
      ></div>
      <div
        class="relative bg-gradient-to-b from-[#2A3547] to-[#1D2535] p-6 rounded-full border border-accent-500/20"
      >
    ...
    >
      <p
        class="text-xl text-[#809BB5] gap-2 font-medium flex flex-col items-center"
      >
    ...
    <div class="flex flex-col gap-2">
      <div
        class="grid w-full grid-cols-3 gap-3 mt-2 place-items-center"
      ...
      <p
        class={'text-sm text-[#809BB5]/80 ' +
          (hasClickedTutorial ? 'opacity-0 pointer-events-none' : '')}
      >
